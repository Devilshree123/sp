              ...
              <form>
                <div className="relative mb-6" data-te-input-wrapper-init>
                  ...
                  <label
                    ...
                    className="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-black-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-black peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-black-200 dark:peer-focus:text-black"
                  >
                    Email address
                  </label>
                </div>
                ...
                <div className="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-black-300 after:mt-0.5 after:flex-1 after:border-t after:border-black-300">
                  <p className="mx-4 mb-0 text-center font-semibold dark:text-black-200">
                    OR
                  </p>
                </div>
